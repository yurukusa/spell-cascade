...
The full Godot Engine license: https://github.com/godotengine/godot/blob/master/LICENSE.txt

Godot Engine uses several third-party libraries. Their licenses are listed at:
https://github.com/godotengine/godot/blob/master/COPYRIGHT.txt

## Kenney Tiny Dungeon

- **Website**: https://kenney.nl/assets/tiny-dungeon
- **Author**: Kenney (kenney.nl)
- **License**: CC0 1.0 Universal (Public Domain Dedication)
- **Files used**: `assets/kenney-tiny-dungeon/tile_0108.png`, `tile_0110.png`, `tile_0121.png`

To the extent possible under law, Kenney has waived all copyright and related or
neighboring rights to these assets. This work is published from the Netherlands.

Full license text: https://creativecommons.org/publicdomain/zero/1.0/

## Noto Sans (Godot Default Font)
